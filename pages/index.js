        ...
        <div className="container mx-auto px-10 md:px-20 lg:px-40">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold dark:text-white">Jay Dave</h2>
            ...
            <div className="flex space-x-6">
              <a
                ...
                className="text-gray-600 dark:text-gray-400 hover:text-teal-500 dark:hover:text-teal-500 transition-colors"
              >
